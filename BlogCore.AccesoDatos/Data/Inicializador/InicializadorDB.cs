...
namespace BlogCore.AccesoDatos.Data.Inicializador
{
    public class InicializadorDB : IInicializadorDB
    {
        ...
        public void Inicializar()
        {
            ...
            {
                UserName = "admin@gorila13web.com",
                Email = "admin@gorila13web.com",
                EmailConfirmed = true,
                Nombre = "gorila13web"
            }, "Admin123*").GetAwaiter().GetResult();
            ApplicationUser usuario = _db.ApplicationUser.Where(us => us.Email == "admin@gorila13web.com").FirstOrDefault();
